...
#+begin_src conf :tangle ~/.dotfiles/.config/dunst/dunstrc :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/gpg-agent.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/mcron.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/pulseaudio.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/ssh-agent.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/compton.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/xsettingsd.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/mpd.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/feh.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/dunst.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/nm-applet.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/udiskie.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/pasystray.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/autorandr.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/xmodmap.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/syncthing.scm :mkdirp yes
...
#+begin_src scheme :tangle ~/.dotfiles/.config/shepherd/init.d/xss-lock.scm :mkdirp yes
...
#+begin_src sh :tangle ~/.dotfiles/bin/wacom-laptop :shebang #!/bin/env sh
...
#+begin_src sh :tangle ~/.dotfiles/bin/wacom-screen :shebang #!/bin/env sh
...
#+begin_src sh :tangle ~/.dotfiles/bin/scrot-clipboard :shebang #!/bin/env sh
...
#+begin_src sh :tangle ~/.dotfiles/bin/download-music :shebang #!/bin/env sh
...
#+begin_src sh :tangle ~/.dotfiles/bin/sync-passwords :shebang #!/bin/env sh
