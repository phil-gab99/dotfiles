...
#+begin_src scheme :tangle ~/.config/shepherd/init.d/xss-lock.scm :mkdirp yes
...
#+begin_src sh :tangle ~/bin/wacom-laptop :shebang #!/bin/env sh
...
#+begin_src sh :tangle ~/bin/wacom-screen :shebang #!/bin/env sh
...
#+begin_src sh :tangle ~/bin/scrot-clipboard :shebang #!/bin/env sh
...
#+begin_src sh :tangle ~/bin/download-music :shebang #!/bin/env sh
...
#+begin_src sh :tangle ~/bin/sync-passwords :shebang #!/bin/env sh
