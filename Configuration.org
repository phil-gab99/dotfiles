...
#+begin_src conf :tangle ~/.dotfiles/.local/share/applications/Mars.desktop
  ...
  Exec=eval $(guix shell -m $HOME/.config/guix/manifests/java.scm --search-paths) && java -jar /home/phil-gab99/Packages/Mars4_5.jar
  Terminal=false
...
#+begin_src conf :tangle ~/.dotfiles/.files/.local/share/applications/LMC.desktop
...
#+begin_src shell :tangle ~/.dotfiles/.files/.bash_aliases :shebang # -*- sh -*-
...
#+begin_src shell :tangle ~/.dotfiles/bashrc
  ...
  __conda_setup="$('$HOME/.guix-home/profile/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
  if [ $? -eq 0 ]; then
      eval "$__conda_setup"
  else
      [ -f "$HOME/.guix-home/profile/etc/profile.d/conda.sh" ] && . "$HOME/.guix-home/profile/etc/profile.d/conda.sh"
  fi
  unset __conda_setup
...
#+begin_src lisp :tangle ~/.dotfiles/.archive/.config/nyxt/init.lisp
...
#+begin_src lisp :tangle ~/.dotfiles/.archive/.config/nyxt/evil-mode.lisp
...
#+begin_src lisp :tangle ~/.dotfiles/.archive/.config/nyxt/status.lisp
...
#+begin_src lisp :tangle ~/.dotfiles/.archive/.config/nyxt/adblock.lisp
...
#+begin_src lisp :tangle ~/.dotfiles/.archive/.config/nyxt/style.lisp
...
#+begin_src lisp :tangle ~/.dotfiles/.archive/.config/nyxt/freestance.lisp
...
#+begin_src lisp :tangle ~/.dotfiles/.archive/.config/nyxt/dark-reader.lisp
...
#+begin_src lisp :tangle ~/.dotfiles/.archive/.config/nyxt/search-engines.lisp
...
#+begin_src python :tangle ~/.dotfiles/.files/.config/qutebrowser/config.py :noweb yes
...
#+begin_src conf :tangle ~/.dotfiles/.files/.config/qutebrowser/quickmarks
  ...
  fairstone https://oam.fairstone.ca/en/home
  sentinel https://sentinel.condoweb.app

#+end_src

*JMatrix Rules*

#+begin_src conf :tangle ~/.dotfiles/.files/.config/qutebrowser/jmatrix-rules
...
#+begin_src conf :tangle ~/.dotfiles/.files/.condarc
...
#+begin_src conf :tangle ~/.dotfiles/.archive/.config/dunst/dunstrc :shebang # -*- conf -*-
...
#+begin_src xml :tangle ~/.dotfiles/.archive/.config/fontconfig/fonts.conf
...
#+begin_src conf :tangle ~/.dotfiles/.files/.gitconfig
...
#+begin_src scheme :tangle ~/.dotfiles/.files/.guile :shebang ;; -*- scheme -*-
...
#+begin_src conf :tangle ~/.dotfiles/.files/.mbsyncrc
...
#+begin_src conf :tangle ~/.dotfiles/.archive/.config/mimeapps.list
...
#+begin_src conf :tangle ~/.dotfiles/.archive/.config/mpd/mpd.conf
...
#+begin_src conf :tangle ~/.dotfiles/.files/.config/mpv/mpv.conf
...
#+begin_src shell :tangle ~/.dotfiles/.files/.npmrc
...
#+begin_src fundamental :tangle ~/.dotfiles/.files/.nix-channels
...
#+begin_src conf :tangle ~/.dotfiles/.archive/.config/polybar/config
...
#+begin_src python :tangle ~/.dotfiles/.files/.config/python/history.py
...
#+begin_src conf :tangle ~/.dotfiles/.files/.config/nano/nanorc
...
#+begin_src haskell :tangle ~/.dotfiles/.files/.vimrc
...
#+begin_src conf :tangle ~/.dotfiles/.files/.termux/termux.properties
...
#+begin_src conf :tangle ~/.dotfiles/.archive/.Xdefaults
...
#+begin_src conf :tangle ~/.dotfiles/.archive/.xmodmaprc
...
#+begin_src sh :tangle ~/.dotfiles/.archive/.xsession
...
#+begin_src conf :tangle ~/.dotfiles/.archive/.config/xsettingsd/xsettingsd.conf
...
#+begin_src sh :tangle ~/.dotfiles/.files/bin/extract :shebang #!/usr/bin/env bash
...
#+begin_src sh :tangle ~/.dotfiles/.files/bin/arduino-flat :shebang #!/usr/bin/env bash
...
#+begin_src sh :tangle ~/.dotfiles/.files/bin/bfix
...
#+begin_src sh :tangle ~/.dotfiles/.files/bin/max-charge :shebang #!/usr/bin/env bash
...
#+begin_src sh :tangle ~/.dotfiles/.files/bin/normal-charge :shebang #!/usr/bin/env bash
...
#+begin_src sh :tangle ~/.dotfiles/.files/bin/safe-charge :shebang #!/usr/bin/env bash
...
#+begin_src sh :tangle ~/.dotfiles/.files/bin/mail-init :shebang #!/usr/bin/env bash
...
#+begin_src sh :tangle ~/.dotfiles/.files/bin/download-music :shebang #!/usr/bin/env bash
...
#+begin_src sh :tangle ~/.dotfiles/.files/bin/sync-passwords :shebang #!/usr/bin/env bash
...
#+begin_src scheme :tangle ~/.dotfiles/.files/.config/cron/pass-sync.guile
...
#+begin_src sh :tangle ~/.dotfiles/.files/bin/pprint :shebang #!/usr/bin/env bash
...
#+begin_src sh :tangle ~/.dotfiles/.files/bin/collect-assignments :shebang #!/usr/bin/env bash
...
#+begin_src sh :tangle ~/.dotfiles/.files/bin/wacom-laptop :shebang #!/usr/bin/env bash
...
#+begin_src sh :tangle ~/.dotfiles/.files/bin/wacom-screen :shebang #!/usr/bin/env bash
