...
This environment is used in a course for which I am TA

#+begin_src shell :tangle ~/.dotfiles/.conda/ift_1016/etc/conda/activate.d/env_vars.sh
...
#+begin_src shell :tangle ~/.dotfiles/.conda/ift_1016/etc/conda/deactivate.d/env_vars.sh
...
This environment is used for my personal machine learning practice

#+begin_src shell :tangle ~/.dotfiles/.conda/ml_practice/etc/conda/activate.d/env_vars.sh

  export OLD_LD_LIBRARY_PATH=$LD_LIBRARY_PATH
  export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:$HOME/.conda/envs/ml_practice/lib"

#+end_src

#+begin_src shell :tangle ~/.dotfiles/.conda/ml_practice/etc/conda/deactivate.d/env_vars.sh
...
#+begin_src sh :tangle ~/.dotfiles/bin/arduino-flat :shebang #!/usr/bin/env sh
