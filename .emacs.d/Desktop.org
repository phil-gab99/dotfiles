...
#+begin_src xml :tangle ~/.config/fontconfig/fonts.conf
  ...
  <fontconfig>
    <dir>~/.guix-extra-profiles/desktop/desktop/sahre/fonts</dir>
    <alias>
...
#+begin_src conf :tangle ~/.config/qutebrowser/quickmarks
  ...
  sc https://academique-dmz.synchro.umontreal.ca/psp/acprpr9/EMPLOYEE/SA/c/NUI_FRAMEWORK.PT_LANDINGPAGE.GBL&cmd=login&languageCd=CFR&userid=CAS&pwd=z
#+end_src
