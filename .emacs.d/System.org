...
=3Dphantom=3D is a ThinkPad X1 Extreme that I use for music production and =
video editing.  For whatever reason, loading the =3Dnouveau=3D driver crash=
es the machine upon booting so I've blacklisted it for now until I figure o=
ut how to get it working correctly.

*.config/guix/systems/phantom.scm:*

#+begin_src scheme :tangle .config/guix/systems/phantom.scm

;; NOTE: This file is generated from ~/.dotfiles/System.org.  Please see co=
mmentary there.
